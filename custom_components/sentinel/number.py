...
NUMBER_DESCRIPTIONS = [
    ...
    SentinelNumberDescription(
        key="rebalance_solar_threshold",
        name="Rebalance Solar Threshold",
        icon="mdi:solar-power",
        native_min_value=0.0,
        native_max_value=5.0,
        native_step=0.1,
        native_unit_of_measurement=UnitOfPower.KILO_WATT,
        option_key=OPT_REBALANCE_SOLAR_THRESHOLD,
    ),
    SentinelNumberDescription(
        key="rebalance_solar_override_soc",
        name="Rebalance Solar Override SOC",
        ...
        native_unit_of_measurement=PERCENTAGE,
        mode=NumberMode.BOX,
        option_key=OPT_REBALANCE_SOLAR_OVERRIDE_SOC,
    ),
    SentinelNumberDescription(
